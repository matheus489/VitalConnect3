...
- Item #28 do roadmap
- Estimativa de esforço: M (1 semana)
- O sistema já possui: dashboard de ocorrências, gestão de hospitais, gestão de plantões, sistema de notificações (email, SMS, push), métricas e relatórios
