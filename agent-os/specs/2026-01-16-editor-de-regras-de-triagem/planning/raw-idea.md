# Editor de Regras de Triagem

## Raw Feature Description

**Feature Name:** Editor de Regras de Triagem

**Description:**
Interface visual para gestores criarem e editarem regras de elegibilidade sem necessidade de alteração de código.
...
- Rules determine if a death event triggers a notification
